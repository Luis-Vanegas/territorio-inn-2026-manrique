...
export const metadata: Metadata = {
  ...
  description: 'Escríbele al equipo de Constelaciones — Comuna 3, Manrique.',
};
    ...
    <main className="seccion">
      <header className="max-w-2xl">
        ...
        <p className="mt-6 max-w-xl font-sans text-lg leading-relaxed text-tinta/70">
          ¿Tienes un caso puntual, una corrección o una petición para el equipo?
          Déjanos el mensaje acá.
        </p>
      </header>
