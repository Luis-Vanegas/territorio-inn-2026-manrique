...
export function ModuloProximamente({ modulo }: ModuloProximamenteProps) {
  return (
    <main className="margen-editorial flex min-h-screen flex-col justify-center py-32">
      <span className="font-sans text-xs text-tinta/65">{modulo.numero}</span>
      ...
      <span className="mt-8 font-sans text-sm text-azul-texto">[ Próximamente ]</span>

      <Link
        href="/#enfoque"
        className="mt-16 inline-block w-fit font-sans text-sm text-tinta/65 underline decoration-azul underline-offset-4 hover:text-azul-texto"
      >
