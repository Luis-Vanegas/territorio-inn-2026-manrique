  ...
  return (
    ...
    >
      ...
      <div className="mt-3 flex flex-wrap items-center justify-between gap-x-4 gap-y-2">
        <p className="font-sans text-sm text-tinta/65">{foto.pie}</p>
        ...
        <div className="flex items-center gap-1">
          ...
          <button
            ...
            className="flex h-11 w-11 items-center justify-center border border-tinta/55 font-sans text-base text-tinta transition-colors hover:border-azul-texto hover:text-azul-texto"
          >
          ...
          <p className="w-14 text-center font-sans text-sm text-tinta/65">
