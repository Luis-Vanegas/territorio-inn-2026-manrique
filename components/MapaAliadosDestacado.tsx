    ...
    <div>
      ...
      {estado === 'sin_permiso' && (
        <button
          type="button"
          onClick={reintentar}
          className="mt-3 inline-flex items-center gap-2 border border-tinta/20 px-3 py-1.5 font-mono text-xs text-tinta/60 transition-colors hover:border-azul-texto hover:text-azul-texto"
        >
